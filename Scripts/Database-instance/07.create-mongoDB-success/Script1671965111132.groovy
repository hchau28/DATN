...
CustomKeywords.'myPackage.myKeywords.checkTextExists'(findTestObject('Page_Khi to Database Instance - Create DB/Page_Database Instances - Thong bao/h2_Thnh cng'), 
    'Thành công')
