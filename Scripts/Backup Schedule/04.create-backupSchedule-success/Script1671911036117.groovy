...
WebUI.click(findTestObject('Page_Backups - Bizfly Database Dashboard/div_To Backup Schedules'))
...
WebUI.setText(findTestObject('Page_To Backup Schedule - Bizfly Database Dashboard/input__el-input__inner'), 'A12345')
